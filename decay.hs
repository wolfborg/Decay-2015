...
menu1 = Menu
  "You are a superhero. What is your power?"
  ["Spider-powers", "Invisibility", "I have a lot of money"]
  [spiderman1, invisible1, batman1]

spiderman1 = Menu
  "You are Spider-Man, or at least a cheap rip-off of him.\nUsing your spider-senses, speed, and webs,\nyou fight crime and deliver pizzas in New York City.\nYou also used to have an Uncle Ben."
  ["End"]
  [endMenu]


invisible1 = Menu
  "You have the power of invisibility,\nwhich could be very dangerous in the wrong hands.\nTry not to get into too much trouble."
  ["End"]
  [endMenu]
  
batman1 = Menu
  "You are Batman. You have a lot of money,\nbut you can't buy your parents back to life.\nYou have a lot of gadgets you use to fight criminals."
  ["End"]
  [endMenu]